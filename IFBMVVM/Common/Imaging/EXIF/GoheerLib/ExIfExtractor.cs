// http://www.codeproject.com/Articles/11305/EXIFextractor-library-to-extract-EXIF-information?msg=4434569#xx4434569xx
...
namespace IFBMVVM.Common.Imaging.EXIF.GoheerLib
{
    public class ExIfExtractor : IEnumerable
	{
		...
		private void buildDB(System.Drawing.Imaging.PropertyItem[] parr)
		{
			...
			foreach (System.Drawing.Imaging.PropertyItem p in parr)
			{
                ...
                {
					Debug.WriteLine("ERROR while reading prop: " + name + " | ERR MSG: " + ex.Message + "\r\n" + ex.StackTrace);
                }
			}
